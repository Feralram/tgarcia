...
<body class="g-sidenav-show bg-gray-200">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Agregar alumnos</h6>
                </nav>
            </div>
        </nav>
                ...
                <!-- <div class="col-lg-4 col-md-3 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            <li class="nav-item">
                                <button class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false">
                                    <span class="material-icons text-lg position-relative">upload_file</span>
                                    <span class="ms-1">Cargar Lista de Alumnos</span>
                                </button>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card card-plain h-100">
                                <div class="card-header pb-0 p-3">
                                    <h6 class="mb-0">Registrar Alumno</h6>
                                    <h6 class="text-body text-xs font-weight-bolder">Registra a un solo alumno</h6>
                                </div>
    ...
    <script src="../ajax/admin/create-student.js"></script>
