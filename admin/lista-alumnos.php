  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Personal escolar</li>
          ...
          <h6 class="font-weight-bolder mb-0">Alumnos</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Tabla de alumnos</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-4">
                ...
                <table class="table align-items-center mb-0" id="miTabla" class="display" style="width:100%">
                  <thead>
                      <tr>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Alumno/Folio</th>
...
<script src="https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js"></script>
  ...
  <script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: 'php/tablaAlumnos.php', // Ruta al archivo PHP que obtiene los datos
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                  switch (data[i].astatus) {
                    case 1:
                    Textostatus = '<span class="badge badge-sm bg-gradient-warning">Pendiente</span>';
                    TextoDocumentos = '<td class="align-middle text-center text-sm"><a href="./ver-documentos-alumno.php?id='+ data[i].id +'"><span class="material-symbols-rounded">folder_open</span></td>';
                      break;
                    ...
                    $('#miTabla tbody').append(
                        '<tr>' +
                        '<td><div class="d-flex px-2 py-1"> <div class="d-flex flex-column justify-content-center"> <h6 class="mb-0 text-sm">' + data[i].nombre + '</h6><p class="text-xs text-secondary mb-0">'+ data[i].folio +'</p></div></div></td>' +
                        '<td><div class="d-flex px-2 py-1"> <div class="d-flex flex-column justify-content-center"> <span class="text-secondary text-xs font-weight-bold">Primer grado</span></div></div></td>' +
                        '<td class="align-middle text-center text-sm"><a href="./ver-alumno.php?id='+ data[i].id +'"><span class="material-symbols-rounded">description</span></td>' +
                        TextoDocumentos +
                        ...
                        '<td class="align-middle text-center text-sm"><a onclick="return confirmarEnvio()" href="../controllers/Alumno/controllerAlumnos.php?accion=2&id='+ data[i].id +'" class="delete-icon"><span class="material-symbols-rounded">delete</span></a></td>' +                                                
                        '</tr>'                        
                    );
                }
...
<script>
  function confirmarEnvio() {
    ...
    var respuesta = confirm("¿Estás seguro de eliminar este alumno?");
