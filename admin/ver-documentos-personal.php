...
<head>
    ...
    <title>
        SIGE | Documentos del personal escolar
    </title>
    <!--     Fonts and icons     -->
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">Documentos personal docente</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <!-- <div class="input-group-mody input-group-static mb-4 card-header">
                                <label for="floatingTextarea">Comentarios</label>
                                <textarea class="form-control" id="floatingTextarea" rows="5"></textarea>
                            </div>FS2301244557 -->
                            <div class="table-responsive p-4">
                                <table class="table align-items-center mb-0" id="miTabla" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nombre del documento</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ver documento</th>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Eliminar documento</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Aprobar documento</th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ol>
                        ...
                        <li>Que el documento PDF entregado por el profesor sea el correcto.</li>
...
<script src="https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'php/documentosPersonal.php?id='+id, // Ruta al archivo PHP que obtiene los datos
                type: 'GET',
                dataType: 'json',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#miTabla tbody').append(
                            '<tr>' +
                            '<td><div class="d-flex px-2 py-1"> <div class="d-flex flex-column justify-content-center"> <h6 class="mb-0 text-sm">' + data[i].Nombre + '</h6></div></div></td>' +                            
                            ...
                            '<td class="align-middle text-center text-sm"><a onclick="return confirmarEnvio()" href="../controllers/personal-escolar/controllerPescolar.php?accion=1&PescolarId='+id+'&id='+ data[i].id +'" class="delete-icon"><span class="material-symbols-rounded">delete</span></a></td>' +
                            '<td class="align-middle text-center text-sm"><a type="button" onclick="getDocumentID(' + data[i].Tipo + ')" data-document="' + data[i].Estatus + '" data-bs-toggle="modal" data-bs-target="#ApproveModal" class="approve-icon"><span class="material-icons">task</span></a></td>' +
                            '</tr>'                        
                        );
                    }
                    ...
                    if (miTabla.rows().count() === 0) {
                        ...
                        window.location.href = 'lista-personal-escolar.php';                        
                    }
                }
    ...
    <script>function confirmarEnvio() {
...
<script src="../ajax/admin/approve-document-escolar.js"></script>
</body>
